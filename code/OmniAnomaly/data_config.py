...
def get_offline_pvt_baseline(data_index_list):
    pass

def remove_extreme_by_baseline(data_index, training_period, cluster_baseline, train_data):
...
exp_dir = pathlib.Path(out_dir) /"OmniAnomaly" / exp_key
