...
def main():
    ...
    for cluster in clusters:
        ...
        cluster_baseline=get_offline_pvt_baseline(cluster['train'][:train_num])       
        for test_id in cluster['test']:
            ...
            train_data_item_raw, test_data_item = get_data_by_index(test_id, preprocess_train_days)
            ...
            valid_portion = 0.4 if training_period <= 2 and "data1" is None else 0.3
