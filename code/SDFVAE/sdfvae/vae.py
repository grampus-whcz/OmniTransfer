...
class VAE(nn.Module):
    def __init__(self, s_dim=8, d_dim=10, conv_dim=100, hidden_dim=40,
        ...
        if self.enc_dec == 'CNN':  
            ...
            if self.n == 19:  # data1
                k0_0, s0_0, p0_0, op0_0 = 3, 2, 0, 0
                k0_1, s0_1, p0_1, op0_1 = 3, 2, 0, 0
                k0_2, s0_2, p0_2, op0_2 = 2, 2, 0, 0
                # sd_0 = int(self.n / (k0_0 * k0_1 * k0_2))
                sd_0 = 2
            elif self.n == 38:
                ...
                sd_0=3
            elif self.n == 22:  # data1
                k0_0,s0_0,p0_0,op0_0=3,2,2,1
                k0_1,s0_1,p0_1,op0_1=3,2,2,1
                k0_2,s0_2,p0_2,op0_2=3,2,2,0
                sd_0=5
            elif self.n == 27:  # data1
                k0_0,s0_0,p0_0,op0_0=3,2,2,0
                k0_1,s0_1,p0_1,op0_1=3,2,2,0
                k0_2,s0_2,p0_2,op0_2=3,2,2,0
                sd_0=6
            elif self.n == 25:  # data1
                k0_0,s0_0,p0_0,op0_0=3,2,2,0
                k0_1,s0_1,p0_1,op0_1=3,2,2,1
                k0_2,s0_2,p0_2,op0_2=3,2,2,1
                sd_0=5                            
            elif self.n == 49: # ctf
                k0_0,s0_0,p0_0,op0_0=5,2,0,0
                k0_1,s0_1,p0_1,op0_1=2,2,0,1
                k0_2,s0_2,p0_2,op0_2=2,2,0,1
                sd_0=5
            elif self.n == 2:
                k0_0, s0_0, p0_0, op0_0 = 1, 1, 0, 0
                k0_1, s0_1, p0_1, op0_1 = 1, 1, 0, 0
                k0_2, s0_2, p0_2, op0_2 = 1, 1, 0, 0
                sd_0 = 2
            # elif self.n == 48:
            ...
            #     sd_0=int(self.n/(k0_0*k0_1*k0_2))
                ...
                raise ValueError('Invalid Kpi numbers: {}, choose from the candidate set [19,38,22,49].'.format(self.n))
            ...
            #     sd_1=int(self.w/(k1_0*k1_1*k1_2)) 
                ...
                raise ValueError('Invalid window size: {}, choose from the set [36,60,100]'.format(self.w)) 
            ...
            self.cd = [128,sd_0,sd_1] 
            # self.cd = [114,sd_0,sd_1] 

            self.conv = nn.Sequential(
                    ConvUnit(1, 16, kernel=(self.krl[0][0],self.krl[0][1]), 
                                    stride=(self.srd[0][0],self.srd[0][1]),
                                    padding=(self.pd[0][0],self.pd[0][1])),
                    ConvUnit(16, 64, kernel=(self.krl[1][0],self.krl[1][1]),  
                                      stride=(self.srd[1][0],self.srd[1][1]), 
                                      padding=(self.pd[1][0],self.pd[1][1])),
                    ConvUnit(64, 128, kernel=(self.krl[2][0],self.krl[2][1]), 
            ...
            self.deconv_mu = nn.Sequential(
                      ConvUnitTranspose(128, 64, kernel=(self.krl[2][0],self.krl[2][1]), 
                                                stride=(self.srd[2][0],self.srd[2][1]),
                                                out_padding=(self.opd[2][0], self.opd[2][1]),
                                                padding=(self.pd[2][0],self.pd[2][1])
                                        ),
                      ConvUnitTranspose(64, 16, kernel=(self.krl[1][0],self.krl[1][1]), 
                                                stride=(self.srd[1][0],self.srd[1][1]),
                                                out_padding=(self.opd[1][0], self.opd[1][1]),
                                                 padding=(self.pd[1][0],self.pd[1][1])
                                        ),
                      ConvUnitTranspose(16, 1, kernel=(self.krl[0][0],self.krl[0][1]), 
                                               stride=(self.srd[0][0],self.srd[0][1]),
    ...
    def encoder_x(self, x):
        if self.enc_dec == 'CNN':
            # print(x.shape)
            # breakpoint()            
            # print("Input shape:", x.shape)  # e.g., [B, T, n=2, w=36]
            x = x.view(-1, 1, self.n, self.w)
            # print("After view:", x.shape)   # [B*T, 1, 2, 36]
            x = self.conv(x)
            # print("After conv:", x.shape)   # should be [B*T, 128, sd_0=2, sd_1=?]
