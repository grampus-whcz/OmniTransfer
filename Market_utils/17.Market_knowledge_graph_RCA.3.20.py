...
def main():
    ...
    programmatic_summary_path = f"{base_dir}/Market_cluster_window_anomaly_report_{args.date_online}_{args.output_suffix}_programmatic_rca_summary_enhanced.json"
    llm_summary_path = f"{base_dir}/Market_cluster_window_anomaly_report_{args.date_online}_{args.output_suffix}_llm_rca_summary_enhanced.json"
