...
def analyze_anomalies_in_time_range(
    ...
    tc_list = meta["tc_list"]
    columns = meta["columns"]  # e.g., ['rr', 'sr', 'cnt', 'mrt']
    ...
    dt = np.dtype([('entity', 'U32'), ('attribute', 'U8'), ('timestamp', 'i8')])
    if anomalies:
        arr = np.array([
    ...
    report_file_path = os.path.join(report_output_dir, f"Bank_metric_app_anomaly_report_{anomaly_report}.txt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--meta", type=str,
                        ...
                        default="/root/shared-nvme/work/timeSeries/OmniTransfer_new/OpenRCA_preprocess_dataset/Bank/metric/metadata_app_2021_03_06_120s.json")
