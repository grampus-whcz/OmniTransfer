...
class TelecomToGAnalyzer:
    """Original ToG: A local adaptation of Think-on-Graph for telecom RCA over the generated KG. 
    Consume a large amount of LLM calls, but provides a more transparent and traceable reasoning process. 
    Suitable for complex cases where interpretability is crucial."""
