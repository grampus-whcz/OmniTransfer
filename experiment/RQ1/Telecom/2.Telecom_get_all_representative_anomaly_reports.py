...
# 配置
GROUNDTRUTH_FILE = "/root/shared-nvme/work/timeSeries/OmniTransfer_new/experiment/RQ1/Telecom/groundtruth.csv"
SCRIPT_NAME = "1.Telecom_get_representative_anomaly_report_new.py"
OUTPUT_DIR = "./report"
