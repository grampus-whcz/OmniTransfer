...
# 数据
y_blue_n = np.array([0.2742, 0.2419, 0.2903, 0.2258, 0.2419, 0.2419])
y_red_n = np.array([0.0323, 0.0323, 0.0323, 0.0323, 0.0323, 0.0323])
y_green_n = np.array([0.3065, 0.2742, 0.3226, 0.2581, 0.2742, 0.2742])

y_blue_s = np.array([0.1228, 0.0526, 0.0877, 0.0526, 0.0877, 0.0175])
y_red_s = np.array([0.4737, 0.4561, 0.4386, 0.4035, 0.4737, 0.5614])
y_green_s = np.array([0.5965, 0.5088, 0.5263, 0.4561, 0.5614, 0.5789])

y_blue_p = np.array([0, 0, 0, 0, 0, 0])
y_red_p = np.array([0.5294, 0.5294, 0.5294, 0.4706, 0.5294, 0.4706])
y_green_p = np.array([0.5294, 0.5294, 0.5294, 0.4706, 0.5294, 0.4706])
...
# 保存与显示
plt.savefig('0.hyperparameter.pdf', format='pdf', bbox_inches='tight')
plt.show()